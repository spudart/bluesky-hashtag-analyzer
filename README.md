...
2. Here's the specific lines of code to run in Terminal on MacOS. (do not include the dollar sign. That's just how people indicate that it's the start of a new line in a Terminal command)

$ cd /Users/YOURMACOSUSERNAME/Documents/Python-scripts/bsky-like-analysis
$ virtualenv env
